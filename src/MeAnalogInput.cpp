 ...
 *   None
 */
MeAnalogInput::MeAnalogInput(void) : MePort(0)
{
 ...
 */
MeAnalogInput::MeAnalogInput(uint8_t port) : MePort(port)
{
 ...
 */
MeAnalogInput::MeAnalogInput(uint8_t analoginputPin)
{
 ...
 *    None
 */
void MeAnalogInput::setpin(uint8_t analoginputPin)
{
  _analoginputPin = analoginputPin;
  pinMode(_analoginputPin, INPUT);
#ifdef ME_PORT_DEFINED
  _pin[OFFSET_0] = analoginputPin;
#endif // ME_PORT_DEFINED
}
 ...
 *    None
 */
uint16_t MeAnalogInput::read(void)
{
#ifdef ME_PORT_DEFINED
