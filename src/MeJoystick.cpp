...
volatile uint8_t MeJoystick::_XY_port = 0;
 ...
 */
MeJoystick::MeJoystick(uint8_t xy_port)
{
  _XY_port = xy_port;
}
 ...
 *   None
 */
void MeJoystick::setpin(uint8_t xy_port)
{
  _XY_port = xy_port;
}
...
int16_t MeJoystick::readX(void)
{
  int16_t x_value;
#ifdef ME_PORT_DEFINED
  x_value = MePort::aRead(OFFSET_0);
#else // ME_PORT_DEFINED
  x_value = analogRead(_XY_port);
#endif // ME_PORT_DEFINED
...
int16_t MeJoystick::read(uint8_t index)
{
  ...
  {
#ifdef ME_PORT_DEFINED
    value = MePort::aRead(OFFSET_0);
#else // ME_PORT_DEFINED
    value = analogRead(_XY_port);
#endif // ME_PORT_DEFINED
  ...
  {
#ifdef ME_PORT_DEFINED
    value = MePort::aRead(OFFSET_1);
#else // ME_PORT_DEFINED
    value = analogRead(XY_port);
#endif // ME_PORT_DEFINED
